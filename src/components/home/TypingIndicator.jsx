...
const textSequence = [
  "Learn Smarter, Faster, and More Efficiently",
  "Your Experience, Your Intelligence",
  "Discover the Perfect Answer—Instantly",
      ...
      <Container maxW={'3xl'}>
        <Stack
          ...
          <Box textAlign="center">
            <TypeAnimation
            sequence={textSequence.flatMap((text) => [text, 1000])}
            wrapper="h4"
            speed={50}
            style={{
